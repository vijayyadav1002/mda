...
interface CompressQueueItemProps {
  readonly job: CompressJob;
  readonly isExpanded: boolean;
  readonly onToggleExpand: () => void;
  readonly previewAssetId: string | null;
  readonly onSetPreviewAssetId: (id: string | null) => void;
...
export function CompressQueueItem({
  job, isExpanded, onToggleExpand, previewAssetId, onSetPreviewAssetId, apiUrl,
  onConfirm, onDismiss, onCancel, onConfirmFile, onDiscardFile,
}: CompressQueueItemProps) {
                  ...
                  {job.previews.map(p => {
                    ...
                    return (
                      ...
                      >
                        ...
                        <button
                          type="button"
                          onClick={() => onSetPreviewAssetId(previewAssetId === p.assetId ? null : p.assetId)}
                ...
                return (
                  <div className="bg-[#060e20] rounded-xl overflow-hidden">
                    <div className="px-3 py-2 flex justify-between items-center">
                      ...
                      <button type="button" onClick={() => onSetPreviewAssetId(null)} className="p-1 text-white/40 hover:text-white/80 transition-colors">
                        <X className="w-3 h-3" />
                      </button>
                    </div>
